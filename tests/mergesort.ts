...
describe('merge sort', () => {
  code(() => {
    ...
    class IntListPartition {
      ...
      invariant() {
        return (
          (this.left === null || this.left instanceof IntList) && (this.right === null || this.right instanceof IntList)
        );
      }
    }
    ...
    function isSorted(list) {
      ...
      return list === null || list.tail === null || (list.head <= list.tail.head && isSorted(list.tail));
    }
    ...
    function merge(left, right) {
      ...
      ensures(
        (res) =>
          !(left !== null && (right === null || right.head >= left.head)) || (res !== null && res.head === left.head)
      );
      ensures(
        (res) =>
          !(right !== null && (left === null || right.head < left.head)) || (res !== null && res.head === right.head)
      );
      ensures(pure());
  ...
  verified(
    'merge: (!((left !== null) && ((right === null) || (right.head >= left.head))) || ' +
      '((res !== null) && (res.head === left.head)))'
  );
  verified(
    'merge: (!((right !== null) && ((left === null) || (right.head < left.head))) || ' +
