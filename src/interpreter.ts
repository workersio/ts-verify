...
function globalScope(): Scope {
  ...
  scope.define(
    'assert',
    function assert(p: any) {
      if (!p) throw new Error('assertion failed');
    },
    'const'
  );
  scope.define(
    'spec',
    function spec(f: any, id: any, req: any, ens: any) {
      if (f._mapping) {
        ...
        const wrapped: any = function (this: any, ...args: any[]) {
          return Object.values(mapping)
            .reduceRight(function (cont, [req, ens]) {
...
class InterpreterVisitor extends Visitor<void, void, StepResult, StepResult> implements Interpreter {
  ...
  visitOldIdentifierTerm(_term: Syntax.OldIdentifier): void {
    throw new Error('Method not implemented.');
  }
  ...
  visitUnaryTerm(_term: Syntax.UnaryTerm): void {
    throw new Error('Method not implemented.');
  }

  visitBinaryTerm(_term: Syntax.BinaryTerm): void {
    throw new Error('Method not implemented.');
  }

  visitLogicalTerm(_term: Syntax.LogicalTerm): void {
    throw new Error('Method not implemented.');
  }

  visitConditionalTerm(_term: Syntax.ConditionalTerm): void {
    throw new Error('Method not implemented.');
  }

  visitCallTerm(_term: Syntax.CallTerm): void {
    throw new Error('Method not implemented.');
  }

  visitMemberTerm(_term: Syntax.MemberTerm): void {
    throw new Error('Method not implemented.');
  }

  visitIsIntegerTerm(_term: Syntax.IsIntegerTerm): void {
    throw new Error('Method not implemented.');
  }

  visitToIntegerTerm(_term: Syntax.ToIntegerTerm): void {
    throw new Error('Method not implemented.');
  }

  visitTermAssertion(_assertion: Syntax.Term): void {
    throw new Error('Method not implemented.');
  }
  ...
  visitSpecAssertion(_assertion: Syntax.SpecAssertion): void {
    throw new Error('Method not implemented.');
  }

  visitEveryAssertion(_assertion: Syntax.EveryAssertion): void {
    throw new Error('Method not implemented.');
  }

  visitInstanceOfAssertion(_assertion: Syntax.InstanceOfAssertion): void {
    throw new Error('Method not implemented.');
  }

  visitInAssertion(_assertion: Syntax.InAssertion): void {
    throw new Error('Method not implemented.');
  }

  visitUnaryAssertion(_assertion: Syntax.UnaryAssertion): void {
    throw new Error('Method not implemented.');
  }

  visitBinaryAssertion(_assertion: Syntax.BinaryAssertion): void {
    throw new Error('Method not implemented.');
  }
  ...
  visitAssertStatement(_stmt: Syntax.AssertStatement): StepResult {
    return StepResult.NOP;
  }
  ...
  visitDebuggerStatement(_stmt: Syntax.DebuggerStatement): StepResult {
    return StepResult.NOP;
  }
...
${stmt.fields.map((f) => `  this.${f} = ${f};\n`).join('')}
  ...
  stepOut(): any {
    // returns stack frame return value (does not stop at breakpoints)
    const origStackHeight = this.stack.length;
    do {
      const res = this.step();
      if (res === StepResult.DONE || this.isBreaking()) return;
