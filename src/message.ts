...
export interface Verified extends BaseMessage {
  status: 'verified';
}

export interface Unverified extends BaseMessage {
  status: 'unverified';
  model: Model;
}
...
export interface TimeOut extends BaseMessage {
  status: 'timeout';
}
...
export interface Incorrect extends BaseError {
  type: 'incorrect';
  model: Model;
  error: Error;
}
...
export interface Unsupported extends BaseError {
  type: 'unsupported';
  loc: Syntax.SourceLocation;
}
export interface UndefinedIdentifier extends BaseError {
  type: 'undefined-identifier';
}
export interface AlreadyDefinedIdentifier extends BaseError {
  type: 'already-defined';
}
export interface AssignmentToConst extends BaseError {
  type: 'assignment-to-const';
}
export interface ReferenceInInvariant extends BaseError {
  type: 'reference-in-invariant';
}
export interface ModelError extends BaseError {
