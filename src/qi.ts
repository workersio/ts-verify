...
class TriggerEraser extends Transformer {
  visitCallTrigger(_prop: Syntax.CallTrigger): P {
    return tru;
  }

  visitAccessTrigger(_prop: Syntax.AccessTrigger): P {
    return tru;
  }
...
class TriggerCollector extends Reducer<Triggers> {
  ...
  visitForAllAccessObject(_prop: Syntax.ForAllAccessObject): Triggers {
    return this.empty(); // do not collect under quantifier
  }

  visitForAllAccessProperty(_prop: Syntax.ForAllAccessProperty): Triggers {
    return this.empty(); // do not collect under quantifier
  }
}
...
class QuantifierEraser extends Transformer {
  ...
  visitForAllCalls(_prop: Syntax.ForAllCalls): P {
    return tru;
  }
  ...
  visitForAllAccessObject(_prop: Syntax.ForAllAccessObject): P {
    return tru;
  }

  visitForAllAccessProperty(_prop: Syntax.ForAllAccessProperty): P {
    return tru;
  }
}
