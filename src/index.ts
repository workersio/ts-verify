...
export function verificationConditions(
  src: string,
  ...
  try {
    ...
    return e instanceof MessageException ? e.msg : unexpected(e instanceof Error ? e : new Error(String(e)));
  }
}
...
export async function verify(src: string, opts: Partial<Options> = {}): Promise<Array<Message>> {
  ...
  for (const vc of vcs) {
    ...
    try {
      ...
      m = e instanceof MessageException ? e.msg : unexpected(e instanceof Error ? e : new Error(String(e)));
    }
