...
class NameResolver extends Visitor<void, void, void, void> {
  ...
  scoped(
    action: () => void,
    allowsOld: boolean = this.allowOld,
    allowsRef: boolean = this.allowRef,
  ...
  visitLiteralTerm(_term: Syntax.Literal) {
    /* empty */
  }
  ...
  visitPureAssertion(_assertion: Syntax.PureAssertion) {
    /* empty */
  }
  ...
  visitLiteral(_expr: Syntax.Literal) {
    /* empty */
  }
  ...
  visitDebuggerStatement(_stmt: Syntax.DebuggerStatement) {
    /* empty */
  }
